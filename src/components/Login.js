        ...
        <div className="max-w-md mx-auto my-10">
            ...
            <div className="m-7">
                <form action="">
                    ...
                    <div className="mb-6">
                        <button type="button" className="w-full px-3 py-4 text-white bg-indigo-500 rounded-md focus:bg-indigo-600 focus:outline-none">Log in</button>
                    </div>
                    ...
                    <div class="mb-6">
          <button
            class="w-full px-3 py-4 text-white bg-red-500 rounded-md focus:bg-indigo-600 focus:outline-none"
            type="button"
          >
              Login with Google
              </button>
